...
export interface IUpdateUser {
	...
	eml?: string
	pfp?: string
	chatorder?: string[] | FirebaseFirestore.FieldValue
	unread?: { [cid: string]: number | FirebaseFirestore.FieldValue }
}
...
export interface IUpdateChat {
	cid?: cid
	admins?: uid[] | FirebaseFirestore.FieldValue
	users?: uid[] | FirebaseFirestore.FieldValue
	type?: "direct" | "group"
	name?: string
	icon?: string
	lastmsg?: string
	media?: mid[] | FirebaseFirestore.FieldValue
}
...
export interface IUpdateMessage {
	...
	sender?: uid
	reply?: mid
	time?: number | FirebaseFirestore.FieldValue
	type?: "text" | "image"
	status?: { [uid: string]: 1 | 2 | 3 | FirebaseFirestore.FieldValue }
}
...
export interface IUpdatePresenceData {
	isOnline?: boolean
	lastseen?: number | FirebaseFirestore.FieldValue
	listening?: cid
	typing?: boolean
}
...
export interface IUpdateInvite {
	cid?: cid
	expires?: number | FirebaseFirestore.FieldValue
	uses?: number | FirebaseFirestore.FieldValue
}
